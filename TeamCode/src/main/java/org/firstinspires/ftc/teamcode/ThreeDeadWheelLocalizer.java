...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1229.6686407360219; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1158.0040334424116; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 916.7478456227025; // x position of the perpendicular encoder (in tick units)
    }
